...
var questions = [
  {
    // Pregunta 1
    text: `El amarre se debe hacer de forma perpendicular, si no, se puede instalar en ángulos opuestos.`,
    image: `../../assets/images/course/modulo7/5-amarres.jpg`,
  ...
  {
    // Pregunta 2
    text: `Los accesos seguros para el andamio son opcionales.`,
    image: `../../assets/images/course/modulo7/6-rampas.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 3  
    text: `¿La persona competente es capaz de identificar los peligros, predecirlos y tener la autorización para tomar las medidas necesarias?`,
    image: `../../assets/images/course/modulo7/acceso-adecuado.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 4
    text: `Cualquier persona puede operar un andamio de elevador o aéreo.`,
    image: `../../assets/images/course/modulo7/4-colgante.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 5
    text: `Las escaleras portátiles amarradas al andamio pueden ser una opción para un acceso permitido.`,
    image: `../../assets/images/course/modulo7/6-portatil.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 6
    text: `¿Los elevadores aéreos NO son un tipo de andamios?`,
    image: `../../assets/images/course/modulo7/4-aereo.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
...
function checkAll() {
  ...
  if (score >= 80) {
    ...
    generarClave("modulo8"); // Genera y muestra la clave automáticamente
