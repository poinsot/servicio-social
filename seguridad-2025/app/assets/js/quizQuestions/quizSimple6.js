...
var questions = [
  {
    // Pregunta 1
    text: `¿La instalación de barricadas es una forma de proteger zanjas de los vehiculos?`,
    image: `../../assets/images/course/modulo6/unidad6_lam21_foto1.jpg`,
  ...
  {
    // Pregunta 2
    text: `¿Antes de que un trabajador entre a una excavación, la persona competente no debe verificar si falta oxigeno?`,
    image: `../../assets/images/course/modulo6/unidad6_lam4_foto1.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 3  
    text: `Las cajas de zanja o escudo de zanja,¿es uno de los tres métodos de protección contra derrumbes?`,
    image: `../../assets/images/course/modulo6/caja-de-zanja.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 4
    text: `La mayoría de los accidentes ocurren en zanjas no profundas.`,
    image: `../../assets/images/course/modulo6/caja-de-zanja-2.png`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 5
    text: `¿Encontrar agua en una excavación es señal de peligro?`,
    image: `../../assets/images/course/modulo6/unidad6_lam17_foto3.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 6
    text: `¿Después de 4 pies de profundidad no se requiere un método de protección contra derrumbes?`,
    image: `../../assets/images/course/modulo6/unidad6_lam18_foto1.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
...
function checkAll() {
  ...
  if (score >= 80) {
    ...
    generarClave("modulo7"); // Genera y muestra la clave automáticamente
