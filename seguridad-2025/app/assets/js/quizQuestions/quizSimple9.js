...
var questions = [
  {
    // Pregunta 1
    text: `Muchos accidentes son causados por el uso inadecuado y el mal mantenimiento de la herramienta.`,
    image: `../../assets/images/course/modulo9/4-precaucion.jpg`,
  ...
  {
    // Pregunta 2
    text: `Es seguro llevar las herramientas sujetadas por el cable.`,
    image: `../../assets/images/course/modulo9/5-cable.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 3  
    text: `Es seguro ajustar la rueda mientras está girando.`,
    image: `../../assets/images/course/modulo9/6-afilada.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 4
    text: `No se debe probar la herramienta antes de cargarla para asegurarse de que todos los implementos de seguridad funcionan bien.`,
    image: `../../assets/images/course/modulo9/6-cartucho.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 5
    text: `Para operar una herramienta de pólvora debe estar entrenado y tener licencia para usarla.`,
    image: `../../assets/images/course/modulo9/8-polvora.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 0,
    answers: [`Verdadero`, `Falso`],
  ...
  {
    // Pregunta 6
    text: `NO son medidas de precaucion: no exceder el peso ni exceder el indicador de altura que marca el fabricante del gato hidráulico.`,
    image: `../../assets/images/course/modulo9/6-gato.jpg`,
    correctText: `¡Correcto!`,
    incorrectText: `Incorrecto...`,
    correctIndex: 1,
    answers: [`Verdadero`, `Falso`],
...
function checkAll() {
  ...
  if (score >= 80) {
    ...
    generarClave("modulo10"); // Genera y muestra la clave automáticamente
